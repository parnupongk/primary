...
{
    public partial class vender_taxDuplicate : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            int afterCheckDuplicate = checkDuplicate.sql_checkDuplicate("SELECT top 1 Vendor_TaxID FROM Vendor_Info where Vendor_TaxID='" + Request.Form["var01"].ToString() + "' and vendor_type='" + vendor_type + "'");
