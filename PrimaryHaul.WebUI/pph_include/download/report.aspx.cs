...
namespace PrimaryHaul.WebUI.pph_include.download
{
    public partial class report : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            "" + sql_hl + "" +
            "" + sql_vd + "" +
            "Group by Vendor_Code,Vendor_Name,Haulier_Abbr,DC_No,Delivery_Location,Currency, " +
            ...
            "case when RateType='Load' then No_Of_QTY end ";
            SqlCommand rs_detail = new SqlCommand(sql_detail, objConn);
            obj_detail = rs_detail.ExecuteReader();
            obj_detail.Read();
            Response.AddHeader("Content-Disposition", "attachment;filename=Tesco_Finance_Report_" + Request.QueryString["yw"].ToString() + ".xls");
        }
    }
}