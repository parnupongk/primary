...
{
    public partial class report_bh_unloading_cost : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Response.AppendHeader("content-disposition", "attachment; filename=report_bh_unloading_cost_" + Request.QueryString["wkstart"].ToString() + "_to_" + Request.QueryString["wkend"].ToString() + ".xls");
        }
    }
}